...
const { login, register, getConfig , checkWalletName, getVideoGenereId, bannerImages, getVideoData, getSliderImageData, getPreviewData, generateVideoOtp} = require('./routes/index');
